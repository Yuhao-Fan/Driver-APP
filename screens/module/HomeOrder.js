              ...
              <ScrollView style={{flex:1,flexDirection:'row'}}>
                <TouchableOpacity onPress={()=>{this.setState({select:!select});}}>
                  <View style={styles.catLabel}> 
                      <Image style={{height:30,width:30,margin:15}} source={require('../../images/passenger.png')}></Image>
                      <Text style={{flex:2}}>新订单 </Text>
                      <Text style={{flex:3}}>预估收益：{this.props.data.taxi_cost} </Text>
