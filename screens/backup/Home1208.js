...
export default class Home extends React.Component {
  ...
  _Test() {
    ...
    this.Route(Now.latitude,Now.longitude,To.nativeEvent.latitude,To.nativeEvent.longitude)
    // this.setState({
    //   Driverlatitude:'23.0526',
    //   Driverlongitude:'113.3955',
    // })
          ...
          {this.state.orderMode == 0 &&
            <View style={{ flex: 1 }}>
              <View style={sty.BotTop}>
                ...
                <TouchableOpacity style={sty.Bottom1} onPress={() => { this._BottomSwitch(1) }}><Text style={sty.fontSize}>查看</Text></TouchableOpacity>
                <TouchableOpacity style={sty.Bottom1} onPress={() => { this._Test() }}><Text style={sty.fontSize}>接单</Text></TouchableOpacity>
              </View>
