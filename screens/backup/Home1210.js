...
export default class Home extends React.Component {
  ...
  _Test() {
    ...
    else
    {
      ...
      // const{token,latitude,longitude,Driverlatitude,Driverlongitude}=this.state
      // fetch("https://www.kingdom174.work/find_order?username="+username+"&password="+password+"&location=",{method:'GET'})
      //     .then(response=>response.json())
      //     .then(responseJson=>{
          ...
          {this.state.orderMode == 0 &&
            <View style={{ flex: 1 }}>
              <View style={sty.BotTop}>
                ...
                <TouchableOpacity style={sty.Bottom1} onPress={() => { this._Test() }}>
                  {this.state.drivermode==0?
